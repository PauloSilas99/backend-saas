...
const STATUS_MAP: Record<string, ActionStatus> = {
  ...
  'aguardando aprovacao': ActionStatus.WAITING_APPROVAL,
  'aguardando aprovação': ActionStatus.WAITING_APPROVAL,
  waiting_approval: ActionStatus.WAITING_APPROVAL,
  concluido: ActionStatus.COMPLETED,
  concluído: ActionStatus.COMPLETED,
  completed: ActionStatus.COMPLETED,
  aprovado: ActionStatus.COMPLETED,
  rejeitado: ActionStatus.REJECTED,
